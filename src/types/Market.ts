...
export enum ErrorInput {
  ...
  NotCollateralized = 'NotCollateralized',
  BorrowTooSmall = 'BorrowTooSmall',
  NotPermitted = 'NotPermitted',
  InvalidPayment = 'InvalidPayment',
  UnknownAsset = 'UnknownAsset',
  DebuggingDisabled = 'DebuggingDisabled',
  NotYetActive = 'NotYetActive',
  AlreadyActive = 'AlreadyActive',
  OracleContractIdNotSet = 'OracleContractIdNotSet',
...
export type AbsorbCollateralEventInput = {
  account: IdentityInput;
  asset_id: AssetIdInput;
  amount: BigNumberish;
  seize_value: BigNumberish;
  decimals: BigNumberish;
};
export type AbsorbCollateralEventOutput = {
...
export type BuyCollateralEventOutput = {
...
export type CollateralAssetAddedInput = {
  asset_id: AssetIdInput;
  configuration: CollateralConfigurationInput;
};
export type CollateralAssetAddedOutput = {
  asset_id: AssetIdOutput;
  configuration: CollateralConfigurationOutput;
};
...
export type CollateralAssetUpdatedInput = {
  asset_id: AssetIdInput;
  configuration: CollateralConfigurationInput;
};
export type CollateralAssetUpdatedOutput = {
  asset_id: AssetIdOutput;
  configuration: CollateralConfigurationOutput;
};
export type CollateralConfigurationInput = {
  asset_id: AssetIdInput;
  price_feed_id: string;
  decimals: BigNumberish;
  borrow_collateral_factor: BigNumberish;
  liquidate_collateral_factor: BigNumberish;
  liquidation_penalty: BigNumberish;
  supply_cap: BigNumberish;
  paused: boolean;
};
export type CollateralConfigurationOutput = {
  asset_id: AssetIdOutput;
  price_feed_id: string;
  decimals: number;
  borrow_collateral_factor: BN;
  liquidate_collateral_factor: BN;
  liquidation_penalty: BN;
  supply_cap: BN;
  paused: boolean;
};
...
export type MarketBasicsInput = {
  base_supply_index: BigNumberish;
  base_borrow_index: BigNumberish;
  tracking_supply_index: BigNumberish;
  tracking_borrow_index: BigNumberish;
  total_supply_base: BigNumberish;
  total_borrow_base: BigNumberish;
  last_accrual_time: BigNumberish;
};
export type MarketBasicsOutput = {
  base_supply_index: BN;
  base_borrow_index: BN;
  tracking_supply_index: BN;
  tracking_borrow_index: BN;
  total_supply_base: BN;
  total_borrow_base: BN;
  last_accrual_time: BN;
};
export type MarketConfigurationInput = {
...
export type MarketConfigurationOutput = {
  ...
  supply_kink: BN;
  borrow_kink: BN;
  supply_per_second_interest_rate_slope_low: BN;
  supply_per_second_interest_rate_slope_high: BN;
  supply_per_second_interest_rate_base: BN;
  borrow_per_second_interest_rate_slope_low: BN;
  borrow_per_second_interest_rate_slope_high: BN;
  borrow_per_second_interest_rate_base: BN;
  store_front_price_factor: BN;
  base_tracking_index_scale: BN;
  base_tracking_supply_speed: BN;
  base_tracking_borrow_speed: BN;
  base_min_for_rewards: BN;
  base_borrow_min: BN;
  target_reserves: BN;
};
export type MarketConfigurationEventInput = {
  market_config: MarketConfigurationInput;
};
export type MarketConfigurationEventOutput = {
  market_config: MarketConfigurationOutput;
};
...
export type PauseConfigurationInput = {
...
export type PauseConfigurationEventInput = {
  pause_config: PauseConfigurationInput;
};
export type PauseConfigurationEventOutput = {
  pause_config: PauseConfigurationOutput;
};
...
export type PriceDataUpdateInput = {
  update_fee: BigNumberish;
  publish_times: Vec<BigNumberish>;
  price_feed_ids: Vec<string>;
  update_data: Vec<Bytes>;
};
export type PriceDataUpdateOutput = {
  update_fee: BN;
  publish_times: Vec<BN>;
  price_feed_ids: Vec<string>;
  update_data: Vec<Bytes>;
};
export type ReservesWithdrawnEventInput = {
  caller: IdentityInput;
  to: IdentityInput;
  amount: BigNumberish;
};
export type ReservesWithdrawnEventOutput = {
  caller: IdentityOutput;
  to: IdentityOutput;
  amount: BN;
};
...
export type UserBasicInput = {
  principal: I256Input;
  base_tracking_index: BigNumberish;
  base_tracking_accrued: BigNumberish;
};
export type UserBasicOutput = {
  principal: I256Output;
  base_tracking_index: BN;
  base_tracking_accrued: BN;
};
export type UserBasicEventInput = {
  account: IdentityInput;
  user_basic: UserBasicInput;
};
export type UserBasicEventOutput = {
  account: IdentityOutput;
  user_basic: UserBasicOutput;
};
export type UserLiquidatedEventInput = {
  account: IdentityInput;
  liquidator: IdentityInput;
  base_paid_out: BigNumberish;
  base_paid_out_value: BigNumberish;
  total_base: BigNumberish;
  total_base_value: BigNumberish;
  decimals: BigNumberish;
};
export type UserLiquidatedEventOutput = {
  account: IdentityOutput;
  liquidator: IdentityOutput;
  base_paid_out: BN;
  base_paid_out_value: BN;
  total_base: BN;
  total_base_value: BN;
  decimals: number;
};
export type UserSupplyBaseEventInput = {
  account: IdentityInput;
  supply_amount: BigNumberish;
  repay_amount: BigNumberish;
};
export type UserSupplyBaseEventOutput = {
  account: IdentityOutput;
  supply_amount: BN;
  repay_amount: BN;
};
export type UserSupplyCollateralEventInput = {
  account: IdentityInput;
  asset_id: AssetIdInput;
  amount: BigNumberish;
};
export type UserSupplyCollateralEventOutput = {
  account: IdentityOutput;
  asset_id: AssetIdOutput;
  amount: BN;
};
export type UserWithdrawBaseEventInput = {
  account: IdentityInput;
  withdraw_amount: BigNumberish;
  borrow_amount: BigNumberish;
};
export type UserWithdrawBaseEventOutput = {
  account: IdentityOutput;
  withdraw_amount: BN;
  borrow_amount: BN;
};
export type UserWithdrawCollateralEventInput = {
  account: IdentityInput;
  asset_id: AssetIdInput;
  amount: BigNumberish;
};
export type UserWithdrawCollateralEventOutput = {
  account: IdentityOutput;
  asset_id: AssetIdOutput;
  amount: BN;
};
...
const abi = {
  ...
  concreteTypes: [
    ...
    },
    {
      type: '(u256, u256)',
      concreteTypeId:
        '2770d9f762bf8ec295d5c253193cd2897c893401f1f438769f92d212641ec779',
      metadataTypeId: 1,
    },
    {
      type: 'b256',
    ...
    },
    {
      ...
      concreteTypeId:
        '4e6aabd209068d31558291cfd07cff9366801b052a1767bd0a9eb34bf55e8a0e',
      metadataTypeId: 2,
    },
    {
    ...
    },
    {
      ...
      concreteTypeId:
        '31d6845ccbeb9e71f30bf07140659072ce92db76041efd6861d6895dace9e658',
      metadataTypeId: 10,
    },
    {
      type: 'struct events::BuyCollateralEvent',
      concreteTypeId:
        'a95331d2168897d0f550d1c4f7fc582926a79b3e825866ecf8c11ef8dfb692c6',
      metadataTypeId: 11,
    },
    {
      type: 'struct events::CollateralAssetAdded',
      concreteTypeId:
        'ea2a9368cd82d633fcc3411dbff6c25a78c7ccf550034427221102b74d7926db',
      metadataTypeId: 12,
    },
    {
      type: 'struct events::CollateralAssetPaused',
      concreteTypeId:
        '457cc10e18076b4e7a0ccc563fd089b256767bb56a148450f7e58f0d7cbf54ef',
      metadataTypeId: 13,
    },
    {
      type: 'struct events::CollateralAssetResumed',
      concreteTypeId:
        '81fb1b4fe81422099de81384a1f433aac8964b267aac0428e6bf423e46b88df9',
      metadataTypeId: 14,
    },
    {
      type: 'struct events::CollateralAssetUpdated',
      concreteTypeId:
        '6b698723a311c1005f7846d11d7ce209d68d00c120ee855364c14656ffb5b5a7',
      metadataTypeId: 15,
    },
    {
      type: 'struct events::MarketBasicEvent',
      concreteTypeId:
        '6a4af7c6d1aa3fedf33604a44da789ba359bf8f662a56fbc4de9603b8e732291',
      metadataTypeId: 16,
    },
    {
      type: 'struct events::MarketConfigurationEvent',
      concreteTypeId:
        '61d1473d8ec7f29c9b7f67ec6b840b973400d6af66df556a4fb5ea9884f780b7',
      metadataTypeId: 17,
    },
    {
      type: 'struct events::PauseConfigurationEvent',
      concreteTypeId:
        'ecf750cd9cc44add1b8fc9f1b11bb65d0981711b42c84d20aec21ef32bab7682',
      metadataTypeId: 18,
    },
    {
      type: 'struct events::ReservesWithdrawnEvent',
      concreteTypeId:
        '27b6995841bd520fff14deec990e8d66c03d8df59a510fa25e505694b0bc6ebe',
      metadataTypeId: 19,
    },
    {
      type: 'struct events::SetPythContractIdEvent',
      concreteTypeId:
        'd1ce69d85e3baf58b6bc7ebe55774b2c0ff63b955321139eece739000f91b995',
      metadataTypeId: 20,
    },
    {
      type: 'struct events::UserBasicEvent',
      concreteTypeId:
        '496e403bcde15a6d2d8a6ac3ae964a1db2145d27464fad7ae2b0dd4390c90c19',
      metadataTypeId: 21,
    },
    {
      type: 'struct events::UserLiquidatedEvent',
      concreteTypeId:
        '92d691781932f1848ba9433a9b1c09a97f985b331d88a1a289fc54569161d639',
      metadataTypeId: 22,
    },
    {
      type: 'struct events::UserSupplyBaseEvent',
      concreteTypeId:
        '1aed7a0722d2031e0bce0b49bb46e0f91a2237480a9d928eb696c7d1a6d7250c',
      metadataTypeId: 23,
    },
    {
      type: 'struct events::UserSupplyCollateralEvent',
      concreteTypeId:
        '61825e22a76ff7a0ca3ce1004c7d128c7844a8dde36cf7ea9077f8a57ef1f88a',
      metadataTypeId: 24,
    },
    {
      type: 'struct events::UserWithdrawBaseEvent',
      concreteTypeId:
        '3bbf66e44a782b08497502f3c67b5e181f14ef16755805fd800040f902019de1',
      metadataTypeId: 25,
    },
    {
      type: 'struct events::UserWithdrawCollateralEvent',
      concreteTypeId:
        '76ac511aac239f80b30e11716c2a730f0a814ea3acc85a13abb1777519465a4a',
      metadataTypeId: 26,
    },
    {
    ...
    },
    {
      ...
      concreteTypeId:
        '8f0ca9732dda82407f3d36328a5e4b89421c5f1c404a9568afa856df6efb5802',
      metadataTypeId: 28,
    },
    {
      type: 'struct market_abi::structs::MarketConfiguration',
      concreteTypeId:
        '788c494dd193488709eb7174a5299c17819b0c2e68089b18e0474d616080cc9c',
      metadataTypeId: 29,
    },
    {
      type: 'struct market_abi::structs::PauseConfiguration',
      concreteTypeId:
        '8ec71ec402ef77ffda0627839b31dd1444fad8b4a95507e86bfa89f0517dbc3d',
      metadataTypeId: 30,
    },
    {
      type: 'struct market_abi::structs::PriceDataUpdate',
      concreteTypeId:
        '60b16a7d7d88977a17d1cbc5d1d741c4872c833abbe5cd6eaa5e2d741cd8bf19',
      metadataTypeId: 31,
    },
    {
      type: 'struct market_abi::structs::UserBasic',
      concreteTypeId:
        '2878312d8fe9af45fe59b9252d6afa651128c8f755ca8f26ae4d67ede06b8ea1',
      metadataTypeId: 32,
    },
    {
    ...
    },
    {
      ...
      concreteTypeId:
        'd0540b5a00688e21ad7a3f5d7db93636c18f3ef7aed40d4e48f0cffc74683bcb',
      metadataTypeId: 40,
      typeArguments: [
        '229de6686c9c66098e7188f64d380a851d5ebacacaf90d991adf5b5952a70f7b',
      ],
    ...
    },
    {
      ...
      concreteTypeId:
        '135bedc713ecdc7e568f13811c40a9df6a62b44f54789c3f87066e7ccaedcc14',
      metadataTypeId: 40,
      typeArguments: [
        '027212d4a883f4144f8043ef93fee6aa9d766041c7735fa37fae71d45ab6d92d',
      ],
    ...
    },
    {
      ...
      concreteTypeId:
        '1c791a2f63a6d482f33e38564a4c4f67f2351f36419d0c750ce825e233c86ae1',
      metadataTypeId: 44,
    },
    {
      type: 'u256',
  ...
  functions: [
    ...
    },
    {
      ...
      attributes: [
        ...
        {
          name: 'doc-comment',
          arguments: [' * [Price] - The price data retrieved from the oracle.'],
        },
        {
          name: 'doc-comment',
          arguments: [''],
    ...
    },
    {
      ...
      attributes: [
        ...
        {
          name: 'doc-comment',
          arguments: [' * [I256] - The user balance (with included interest).'],
        },
        {
          name: 'doc-comment',
          arguments: [''],
    ...
    },
    {
      ...
      attributes: [
        ...
        {
          name: 'doc-comment',
          arguments: [' * When the contract ID is not set (i.e., it is zero).'],
        },
        {
          name: 'doc-comment',
          arguments: [''],
...
export class Market extends Contract {
  ...
  declare functions: {
    absorb: InvokeFunction<
      [accounts: Vec<IdentityInput>, price_data_update: PriceDataUpdateInput],
      void
    >;
    activate_contract: InvokeFunction<
      [market_configuration: MarketConfigurationInput, owner: IdentityInput],
      void
    >;
    add_collateral_asset: InvokeFunction<
      [configuration: CollateralConfigurationInput],
      void
    >;
    available_to_borrow: InvokeFunction<[account: IdentityInput], BN>;
    balance_of: InvokeFunction<[asset_id: AssetIdInput], BN>;
    buy_collateral: InvokeFunction<
      [
        asset_id: AssetIdInput,
      ...
      void
    >;
    collateral_value_to_sell: InvokeFunction<
      [asset_id: AssetIdInput, collateral_amount: BigNumberish],
      BN
    >;
    debug_increment_timestamp: InvokeFunction<[], void>;
    get_all_totals_collateral: InvokeFunction<[], Vec<[AssetIdOutput, BN]>>;
    get_all_user_collateral: InvokeFunction<
      [account: IdentityInput],
      Vec<[AssetIdOutput, BN]>
    >;
    get_borrow_rate: InvokeFunction<[utilization: BigNumberish], BN>;
    get_collateral_configurations: InvokeFunction<
      [],
      Vec<CollateralConfigurationOutput>
    >;
    get_collateral_reserves: InvokeFunction<
      [asset_id: AssetIdInput],
      I256Output
    >;
    ...
    get_user_balance_with_interest: InvokeFunction<
      [account: IdentityInput],
      I256Output
    >;
    get_user_basic: InvokeFunction<[account: IdentityInput], UserBasicOutput>;
    get_user_collateral: InvokeFunction<
      [account: IdentityInput, asset_id: AssetIdInput],
      BN
    >;
    ...
    quote_collateral: InvokeFunction<
      [asset_id: AssetIdInput, base_amount: BigNumberish],
      BN
    >;
    ...
    update_collateral_asset: InvokeFunction<
      [asset_id: AssetIdInput, configuration: CollateralConfigurationInput],
      void
    >;
    update_fee: InvokeFunction<[update_data: Vec<Bytes>], BN>;
    update_market_configuration: InvokeFunction<
      [configuration: MarketConfigurationInput],
      void
    >;
    update_price_feeds_if_necessary: InvokeFunction<
      [price_data_update: PriceDataUpdateInput],
      void
    >;
    withdraw_base: InvokeFunction<
      [amount: BigNumberish, price_data_update: PriceDataUpdateInput],
      void
    >;
    withdraw_collateral: InvokeFunction<
      [
        asset_id: AssetIdInput,
        amount: BigNumberish,
        price_data_update: PriceDataUpdateInput,
      ...
      void
    >;
    withdraw_reserves: InvokeFunction<
